 ...
 * 历史数据查询
 */
public class DialogFactHistoryTimeAdapter extends BaseAdapter {
	...
	public DialogFactHistoryTimeAdapter(Context context, List<ShawnRainDto> mArrayList) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder mHolder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.dialog_adapter_fact_history_time, null);
